...
- Single-file React app: src/App.jsx (~3.5k lines, deliberately one file for artifact parity — do not split without being asked).
...
- The integration spec in Dropbox (Product & Integrations) governs any API/back-end work: build strictly in milestone order, every exception row needs a test first.
